...
export const DEFAULT_TEMPLATE_50x30: LabelTemplate = {
  ...
  elements: [
    ...
    { id: 'size', type: 'text', x: 4, y: 14.5, fontSize: 8.5, isBold: true, align: 'left', visible: true, staticText: 'SIZE: ' },
    { id: 'sku', type: 'text', x: 46, y: 14.5, fontSize: 8.5, isBold: true, align: 'right', visible: true, staticText: 'SKU: ' },
