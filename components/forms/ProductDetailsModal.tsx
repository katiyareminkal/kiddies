        ...
        <div className="space-y-4 animate-nano max-h-[80vh] overflow-y-auto pr-1">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1 space-y-2.5">
              <div>
                ...
                <h3 className="text-sm sm:text-base font-extrabold text-slate-900 mt-1.5">{product.name}</h3>
                <p className="text-xs font-mono font-bold text-slate-400 mt-0.5">SKU: {product.sku}</p>
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 bg-slate-50 p-3 rounded-lg border border-slate-200">
            <div>
              ...
              <span className="text-sm font-extrabold text-slate-900 font-mono">{formatCurrency(product.sellingPrice)}</span>
            </div>
            {product.rentalPrice ? (
              <div>
